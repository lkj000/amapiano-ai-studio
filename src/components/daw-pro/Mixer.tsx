  ...
  return (
    <div className="h-full flex flex-col bg-card">
      ...
      <div className="h-7 md:h-8 flex items-center px-2 md:px-3 border-b border-border bg-muted/30">
        ...
        <Button variant="ghost" size="sm" className="h-5 md:h-6 text-[10px] md:text-xs hidden sm:flex">
          <Plus className="h-2.5 w-2.5 md:h-3 md:w-3 mr-0.5 md:mr-1" /> Add Insert
        </Button>
      </div>
        ...
        <div className="flex h-full min-h-[300px] md:min-h-[400px] p-1 md:p-2 gap-0.5 md:gap-1">
          {channels.map((channel, index) => (
            ...
            >
              ...
              {/* Effect Slots (collapsed by default) - Hidden on mobile */}
              ...
              <div className="flex-1 flex flex-col items-center py-1 md:py-2 px-1 md:px-2">
                {/* Level Meter */}
                <div className="flex gap-0.5 h-full w-full mb-1 md:mb-2">

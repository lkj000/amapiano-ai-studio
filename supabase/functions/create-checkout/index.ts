...
// AURA-X Pricing Tiers
const PRICE_IDS = {
  pro: "price_1Sdc2mI0J9agoH6HboU6pH1B", // $29/month
  studio: "price_1Sdc34I0J9agoH6H9RmCMb2h", // $99/month
};
...
serve(async (req) => {
  ...
  try {
    ...
    if (!tier || !PRICE_IDS[tier as keyof typeof PRICE_IDS]) {
      throw new Error(`Invalid tier: ${tier}. Must be 'pro' or 'studio'`);
    }
